...
def creat_glove_emb_layer(weights_matrix, non_trainable=False):
...
class Net(nn.Module):
    ...
    def __init__(self, params, weights_matrix=None):
        """
        ...
        if weights_matrix is None:
            ...
            self.embedding, num_embeddings, embedding_dim = creat_glove_emb_layer(weights_matrix, False)
